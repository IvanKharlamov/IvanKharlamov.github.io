...
{
    id: 101,
    name: { en: "Moving Head 230w", es: "Cabeza Móvil 230w" },
    category: "cat.light",
    manufacturer: "Generic",
    priceDay: 30,
    image: "assets/images/PNG2/230W.png",
    description: {
...
{
    id: 102,
    name: { en: "LED Wash 17x19", es: "LED Wash 17x19" },
    category: "cat.light",
    manufacturer: "Generic",
    priceDay: 20,
    image: "assets/images/PNG2/Wash 17x19.png",
    description: {
...
{
    id: 103,
    name: { en: "LED PAR battery", es: "PAR LED a Batería" },
    category: "cat.light",
    manufacturer: "Generic",
    priceDay: 15,
    image: "assets/images/PNG2/led par battery.png",
    description: {
...
},
{
    ...
    manufacturer: "Generic",
    priceDay: 10,
    image: "assets/images/PNG2/LED PAR.png",
    description: {
...
{
    id: 105,
    name: { en: "Aputure Amaran T2c", es: "Aputure Amaran T2c" },
    category: "cat.light",
    manufacturer: "Aputure",
    priceDay: 20,
    image: "assets/images/PNG2/amaran-t2c.png",
    description: {
...
{
    id: 106,
    name: { en: "Showtec Sunstrip MK ii Active", es: "Showtec Sunstrip MK ii Active" },
    category: "cat.light",
    manufacturer: "Showtec",
    priceDay: 20,
    image: "assets/images/PNG2/showtec-sunstrip-active-dmx-mkii.png",
    description: {
...
},
{
    ...
    manufacturer: "Generic",
    priceDay: 15,
    image: "assets/images/PNG2/LED BAR.png",
    description: {
...
{
    id: 108,
    name: { en: "Console GrandMA Command Wing", es: "Consola GrandMA Command Wing" },
    category: "cat.light",
    manufacturer: "MA Lighting",
    priceDay: 100,
    image: "assets/images/PNG2/MA WING.png",
    description: {
    ...
    specs: {
        en: { "Parameters": "2048", "Faders": "6", "Encoders": "4 dual", "DMX Out": "2x 512", "USB": "Yes", "Software": "MA2" },
        es: { "Parámetros": "2048", "Faders": "6", "Encoders": "4 dual", "Salida DMX": "2x 512", "USB": "Sí", "Software": "MA2" }
    }
},
{
    id: 109,
    name: { en: "ENTTEC DMX USB Pro", es: "Interfaz ENTTEC DMX USB Pro" },
    category: "cat.light",
    manufacturer: "ENTTEC",
    priceDay: 15,
    image: "assets/images/PNG2/ENTTEC.png",
    description: {
...
},
{
    ...
    manufacturer: "Generic",
    priceDay: 10,
    image: "assets/images/PNG2/Truss.png",
    description: {
...
{
    id: 202,
    name: { en: "Totem 2m with platform", es: "Tótem 2m con base" },
    category: "cat.structures",
    manufacturer: "Generic",
    priceDay: 20,
    image: "assets/images/PNG2/Totem.png",
    description: {
...
{
    id: 203,
    name: { en: "Stage module 2000x1000 mm", es: "Tarima 2000x1000 mm" },
    category: "cat.structures",
    manufacturer: "Generic",
    priceDay: 30,
    image: "assets/images/PNG2/STAGE MODULE.png",
    description: {
...
{
    id: 301,
    name: { en: "Meyer UPM-2p", es: "Meyer UPM-2p" },
    category: "cat.sound",
    manufacturer: "Meyer Sound",
    priceDay: 30,
    image: "assets/images/PNG2/UPM-2P.png",
    description: {
...
{
    id: 302,
    name: { en: "HK Audio Sonar top", es: "HK Audio Sonar top" },
    category: "cat.sound",
    manufacturer: "HK Audio",
    priceDay: 20,
    image: "assets/images/PNG2/sonar-115-xi.png",
    description: {
...
{
    id: 303,
    name: { en: "HK Audio Sonar sub", es: "HK Audio Sonar sub" },
    category: "cat.sound",
    manufacturer: "HK Audio",
    priceDay: 30,
    image: "assets/images/PNG2/hk-audio-sonar-115-sub-d_62bf0bb9c530e.png",
    description: {
...
{
    id: 304,
    name: { en: "HK Audio Pro 15 active", es: "HK Audio Pro 15 activo" },
    category: "cat.sound",
    manufacturer: "HK Audio",
    priceDay: 30,
    image: "assets/images/PNG2/HK PRO.png",
    description: {
...
{
    id: 305,
    name: { en: "RCF SUB 8008-AS", es: "RCF SUB 8008-AS" },
    category: "cat.sound",
    manufacturer: "RCF",
    priceDay: 100,
    image: "assets/images/PNG2/003_SUB_8008_AS_RIGHT.png",
    description: {
...
},
{
    ...
    manufacturer: "Yamaha",
    priceDay: 0,
    image: "assets/images/PNG2/yAMAHA DXR.png",
    description: {
...
},
{
    ...
    priceDay: 0,
    image: "assets/images/PNG2/logoletter.png",
    description: {
...
{
    id: 401,
    name: { en: "Analogue console 4-8 channels", es: "Consola analógica 4-8 canales" },
    category: "cat.console",
    manufacturer: "Generic",
    priceDay: 15,
    image: "assets/images/PNG2/Analogue console 4 8 .png",
    description: {
...
{
    id: 402,
    name: { en: "Stage box DL 32", es: "Stage box DL 32" },
    category: "cat.console",
    manufacturer: "Midas",
    priceDay: 30,
    image: "assets/images/PNG2/DL32.png",
    description: {
...
{
    id: 403,
    name: { en: "Behringer X32R", es: "Behringer X32R" },
    category: "cat.console",
    manufacturer: "Behringer",
    priceDay: 50,
    image: "assets/images/PNG2/X32.png",
    description: {
...
{
    id: 404,
    name: { en: "Midas M32 live", es: "Midas M32 live" },
    category: "cat.console",
    manufacturer: "Midas",
    priceDay: 90,
    ...
    specs: {
        ...
        es: { "Entradas": "40", "Buses": "25", "Previos": "32 Midas", "Faders": "25 motor", "Grabación": "32x32 USB", "Muestreo": "48 kHz" }
    }
},
{
    id: 501,
    name: { en: "SLXD24E/SM58 G59", es: "SLXD24E/SM58 G59" },
    category: "cat.mics",
    manufacturer: "Shure",
    priceDay: 40,
    image: "assets/images/PNG2/slxd24e-b58-g59.png",
    description: {
...
{
    id: 502,
    name: { en: "Sennheiser E 906", es: "Sennheiser E 906" },
    category: "cat.mics",
    manufacturer: "Sennheiser",
    priceDay: 10,
    image: "assets/images/PNG2/Sennheiser E 906.png",
    description: {
...
{
    id: 503,
    name: { en: "Shure SM 58/57", es: "Shure SM 58/57" },
    category: "cat.mics",
    manufacturer: "Shure",
    priceDay: 10,
    image: "assets/images/PNG2/Shure 57 58 .png",
    description: {
...
{
    id: 504,
    name: { en: "EV RE 20", es: "EV RE 20" },
    category: "cat.mics",
    manufacturer: "Electro-Voice",
    priceDay: 20,
    image: "assets/images/PNG2/Re20 .png",
    description: {
...
{
    id: 601,
    name: { en: "CDJ 2000 NXS", es: "CDJ 2000 NXS" },
    category: "cat.dj",
    manufacturer: "Pioneer DJ",
    priceDay: 40,
    image: "assets/images/PNG2/cdj-2000nxs2-angle.png",
    description: {
...
{
    id: 602,
    name: { en: "DJM 900", es: "DJM 900" },
    category: "cat.dj",
    manufacturer: "Pioneer DJ",
    priceDay: 40,
    image: "assets/images/PNG2/DJM900.png",
    description: {
    ...
    specs: {
        ...
        es: { "Canales": "4", "FX": "Color + Beat", "Audio": "24-bit", "Entradas": "Phono/Line", "USB": "Sí", "Tarjeta": "Integrada" }
    }
},
{
    id: 603,
    name: { en: "Technics SL1200 MK3D", es: "Technics SL1200 MK3D" },
    category: "cat.dj",
    manufacturer: "Technics",
    priceDay: 40,
    image: "assets/images/PNG2/technics-sl-1200-mk2.png",
    description: {
    ...
    specs: {
        ...
        es: { "Tracción": "Directa", "Velocidades": "33/45 rpm", "Par": "1.5 kgf", "Pitch": "±8 %", "Wow Flutter": "0.01%", "Peso": "12.5 kg" }
    }
},
{
    id: 604,
    name: { en: "DJ table UDG U91072BL", es: "Mesa DJ UDG U91072BL" },
    category: "cat.dj",
    manufacturer: "UDG",
    priceDay: 15,
    image: "assets/images/PNG2/DJ TABLE.png",
    description: {
    ...
    specs: {
        en: { "Width": "140 cm", "Depth": "50 cm", "Height": "95 cm", "Material": "Plywood", "Foldable": "Yes", "Color": "Black" },
        es: { "Ancho": "140 cm", "Fondo": "50 cm", "Altura": "95 cm", "Material": "Contrachapado", "Plegable": "Sí", "Color": "Negro" }
    }
},
{
    id: 701,
    name: { en: "32 A distribution source", es: "Cuadro de distribución 32A" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 20,
    image: "assets/images/PNG2/Distribution 32.png",
    description: {
    ...
    specs: {
        en: { "Input": "32A 3P", "Voltage": "400 V", "Outputs": "16A + CEE", "Protection": "RCD + MCB", "Phases": "3", "Mount": "Flightcase" },
        es: { "Entrada": "32A 3F", "Voltaje": "400 V", "Salidas": "16A + CEE", "Protección": "RCD + MCB", "Fases": "3", "Montaje": "Flightcase" }
    }
},
{
    id: 702,
    name: { en: "63 A distribution source", es: "Cuadro de distribución 63A" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 30,
    image: "assets/images/PNG2/logoletter.png",
    ...
    specs: {
        en: { "Input": "63A 3P", "Voltage": "400 V", "Outputs": "32A + Schuko", "Protection": "RCBO", "Phases": "3", "Mount": "Flightcase" },
        es: { "Entrada": "63A 3F", "Voltaje": "400 V", "Salidas": "32A + Schuko", "Protección": "RCBO", "Fases": "3", "Montaje": "Flightcase" }
    }
},
{
    id: 703,
    name: { en: "32 A cable (meters)", es: "Cable 32A (metros)" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 1.5,
    image: "assets/images/PNG2/cee-cable-32a-5g6-5m.png",
    description: {
...
{
    id: 704,
    name: { en: "63 A cable (meters)", es: "Cable 63A (metros)" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 2.5,
    image: "assets/images/PNG2/Cable 63.png",
    description: {
...
{
    id: 705,
    name: { en: "16 A 3 P cable (meters)", es: "Cable 16A 3P (metros)" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 1,
    image: "assets/images/PNG2/16a 3 phase.png",
    description: {
...
{
    id: 706,
    name: { en: "Schuko 3-5m 3x2,5 wire", es: "Cable Schuko 3-5m 3x2,5" },
    category: "cat.electricity",
    manufacturer: "Generic",
    priceDay: 2,
    image: "assets/images/PNG2/SCHUKO.png",
    description: {
...
},
{
    ...
    description: {
        en: "Experienced lighting operator handling programming and live operation during shows.",
...
{
    id: 902,
    name: { en: "Conference Pack", es: "Pack Conferencia" },
    category: "cat.packs",
